...
# Deploys App Service and Azure SQL Database
# ============================================
...
# Deploy Infrastructure (App Service + SQL)
echo ""
echo "Step 3: Deploying infrastructure (App Service + Azure SQL)..."
...
echo ""
echo "Note: The Chat UI will show a message that GenAI services"
echo "are not deployed. Run deploy-with-chat.sh to enable AI features."
echo ""
echo "To run locally:"
echo "1. Change connection string in appsettings.json to use:"
echo "   Authentication=Active Directory Default"
echo "2. Run: az login"
echo "3. Run: cd src/ExpenseManagement && dotnet run"
echo ""
